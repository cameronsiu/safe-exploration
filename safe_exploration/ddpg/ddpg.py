...
class DDPG:
    ...
    def train(self, output_folder: str):
        ...
        torch.save(actor_state_dict, output_folder + "actor.pt")

        critic_state_dict = self._critic.state_dict()
        torch.save(critic_state_dict, output_folder + "critic.pt")
    ...
    def load(self, output_folder: str):
        actor_state_dict = torch.load(output_folder + f"actor.pt")
        self._actor.load_state_dict(actor_state_dict)

        critic_state_dict = torch.load(output_folder + f"critic.pt")
