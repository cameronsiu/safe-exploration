...
from safe_exploration.utils.namespacify import Namespacify
from safe_exploration.utils.path import get_config_path
...
class Config:
    ...
    def _load_config(cls, args=None):
        ...
        config_file_path = get_config_path("defaults.yml")
        ...
        parsed_config = cls._split_namespace(config["name"], config["arguments"], parser.parse_known_args(args)[0].__dict__)
